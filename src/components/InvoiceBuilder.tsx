...
export function InvoiceBuilder() {
  ...
  async function createPdf() {
      ...
      doc.setFont("helvetica", "bold"); doc.setFontSize(6.2); doc.text(`Account title: ${paymentDetails.accountTitle}`, margin + 4, paymentMethodsY + 23); doc.text(`Account title: ${paymentDetails.accountTitle}`, 110, paymentMethodsY + 23);
      doc.text(`Account number: ${paymentDetails.bankAccountNumber}`, margin + 4, paymentMethodsY + 28); doc.text(`Account number: ${paymentDetails.jazzCashNumber}`, 110, paymentMethodsY + 28);
