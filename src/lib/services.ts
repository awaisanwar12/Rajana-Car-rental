...
export const services = [
  ...
  },
  {
    ...
    faqs: [
      ["What is the Lahore to Islamabad starting rate?", "The current starting price is shown on this page and is updated by Rajana. Confirm the complete final quote, including any route-specific terms, before booking."],
