...
export const services = [
  {
    ...
    introduction: "Get Car provides chauffeur-driven vehicles for people who want a comfortable, practical way to travel in Lahore. Choose the car that fits your passengers and luggage, then share your route and timing so the team can confirm availability and the final trip quote.",
    ...
    whatsAppMessage: "Hello Get Car, I need a car with driver in Lahore. My route is: ",
    faqs: [
      ["Does every Get Car rental include a driver?", "Yes. Get Car offers chauffeur-driven car rental so the driver and vehicle are arranged together for the confirmed trip."],
      ["Which car should I choose?", "Share your passenger count, luggage and route. Get Car can recommend an economy sedan, family vehicle, SUV or group van based on the trip."],
  ...
  },
  {
    ...
    introduction: "For airport travel, timing and luggage matter. Get Car arranges a chauffeur-driven vehicle for travel to or from Allama Iqbal International Airport after confirming your pickup point, flight timing, passengers and luggage on WhatsApp.",
    ...
    planningCopy: ["For an airport pickup, send the flight number or arrival time, the terminal if known, and the number of passengers with luggage. For an airport drop-off, share your pickup address and the time you need to arrive at the airport.", "Get Car confirms the vehicle and final price in writing before the journey. This keeps the booking clear for both the traveller and the driver."],
    ...
    whatsAppMessage: "Hello Get Car, I need a Lahore Airport transfer. My flight/travel timing is: ",
    faqs: [
      ["Can I book an airport pickup in advance?", "Yes. Advance booking is recommended so Get Car can confirm the appropriate vehicle and driver for your flight timing."],
      ...
      ["Can you arrange a larger vehicle for luggage or a group?", "Yes. Tell Get Car how many people and bags are travelling so a suitable vehicle can be confirmed."],
    ],
  },
  {
    slug: "lahore-to-islamabad-car-rental",
    title: "Lahore to Islamabad Car Rental with Driver",
    description: "Book a Lahore to Islamabad chauffeur-driven car for a direct one-way or return intercity journey. Request your final quote on WhatsApp.",
    eyebrow: "Lahore to Islamabad intercity travel",
    heading: "Travel from Lahore to Islamabad in one confirmed car.",
    introduction: "A direct intercity booking means your driver, vehicle and journey details are settled before you leave Lahore. Get Car offers Lahore to Islamabad chauffeur-driven travel for families, business travellers and people who need a practical one-way drop or return journey.",
    image: "/images/toyota-altis.webp",
    imageAlt: "Toyota Corolla Altis for Lahore to Islamabad car rental with driver",
    imageNote: "One-way and return journey options",
    ...
    whatsAppMessage: "Hello Get Car, I need a Lahore to Islamabad car with driver. My travel date and route are: ",
    faqs: [
      ["What is the Lahore to Islamabad starting rate?", "The current starting price is shown on this page and is updated by Get Car. Confirm the complete final quote, including any route-specific terms, before booking."],
      ["Can I arrange a one-way Lahore to Islamabad drop?", "Yes. Tell Get Car that the booking is one-way and share the exact destination and travel date."],
  ...
  },
  {
    ...
    introduction: "Wedding-day transport needs clear timing, suitable cars and reliable coordination. Get Car can arrange chauffeur-driven sedans, SUVs and larger vehicles for couple transport, family journeys and guest movement after confirming your event plan directly on WhatsApp.",
    ...
    whatsAppMessage: "Hello Get Car, I need wedding transport in Lahore. My event date and requirements are: ",
    faqs: [
      ["Can I book cars for wedding guests as well as the couple?", "Yes. Share the number of guests, pickup areas and event timing so Get Car can advise on suitable cars or larger vehicles."],
  ...
  },
  {
    ...
    introduction: "Get Car provides chauffeur-driven vehicles for business meetings, client pickups, office travel, airport transfers and intercity business journeys. Share the travel schedule and passenger requirements to receive a practical vehicle recommendation and confirmed quote.",
    ...
    whatsAppMessage: "Hello Get Car, I need a corporate car in Lahore. My travel schedule is: ",
    faqs: [
      ["Can Get Car arrange a car for a client pickup?", "Yes. Share the client pickup point, destination, date and time so the suitable chauffeur-driven vehicle can be confirmed."],
      ["Can a corporate booking include several stops?", "Yes. List each planned stop and the approximate schedule so Get Car can quote accurately."],
